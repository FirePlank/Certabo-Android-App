...
import berserk
from lichess.certabo import certabo
# from lichess.certabo.certabo import CERTABO_DATA_PATH as CERTABO_DATA_PATH
...
def main(portname, token, connection_method, kill_thread_event, correspondence=True, calibrate=False):
    logging.info("lichess.py startup")
    ...
    mycertabo = certabo.Certabo(port=portname, connection_method=connection_method, kill_thread_event=kill_thread_event, calibrate=calibrate)
